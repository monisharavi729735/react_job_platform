        ...
        <div className="grid grid-cols-1 md:grid-cols-[70%_30%] w-full gap-6">
          <main>
            ...
            >
              ...
              >
                <FaMapMarker className='text-red-600 inline text-lg mb-1 mr-1'/>
                <p className="text-orange-700">{job.location}</p>
              </div>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              <h3 className="text-pink-800 text-lg font-bold mb-6">
                Job Description
              </h3>
              ...
              <h3 className="text-pink-800 text-lg font-bold mb-2">Salary</h3>
          ...
          <aside>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="my-2 bg-pink-100 p-2 font-bold">
                {job.company.contactEmail}
              </p>

              <h3 className="text-xl">Contact Phone:</h3>

              <p className="my-2 bg-pink-100 p-2 font-bold">{job.company.contactPhone}</p>
            </div>
